...
| 14 | Mahalle Yaşam Kalitesi Skoru Görüntüleme | Tamamlandı | `GET /myki/{neighborhood_id}`, `GET /statistics/neighborhood/{neighborhood_id}/summary`, `GET /dashboard/home`, `GET /neighborhoods/{neighborhood_id}/details` | MYKI backend tarafinda bulanik mantik (Fuzzy Logic) ile hesaplaniyor. |
